...
class JuceOSC : private OSCReceiver, private OSCReceiver::Listener<OSCReceiver::RealtimeCallback>, public GUI {
    ...
    public:
        ...
        JuceOSC(const std::string& ip, int in_port, int out_port)
