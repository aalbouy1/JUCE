...
public:
    ...
    virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
        ...
        for (int i = 0; (i < count); i = (i + 1)) {
            ...
            fVec21[(IOTA & 31)] = ((4.65661287e-10f * (fTemp1 * float((fRec23[0] > 0.0f)))) + (0.499449611f * ((fTemp3 * fRec22[1]) + (fTemp4 * fRec22[2]))));
            ...
            fVec35[(IOTA & 511)] = ((4.65661287e-10f * (fTemp1 * float((fRec37[0] > 0.0f)))) + (0.493442565f * ((fTemp3 * fRec36[1]) + (fTemp4 * fRec36[2]))));
            ...
            output1[i] = FAUSTFLOAT((fSlow0 * ((1.5f * ((((((0.768706143f * fRec18[0]) + (fTemp10 + (((((0.369274467f * fRec8[0]) + (0.213200718f * fRec0[0])) + (0.4767313f * fRec10[0])) + (0.564076066f * fRec12[0])) + (0.639602125f * fRec14[0])))) + (0.825722814f * fRec20[0])) + (0.879049063f * fRec22[0])) + (0.929320395f * fRec24[0])) + (0.977008402f * fRec26[0]))) + (0.213200718f * ((1.73205078f * (fRec28[0] + ((((((((((fRec31[0] + ((0.577350259f * fRec34[0]) + (0.577350259f * fRec36[0]))) + (1.29099441f * fRec38[0])) + (1.52752519f * fRec40[0])) + (1.73205078f * fRec42[0])) + (1.91485417f * fRec44[0])) + (2.08166599f * fRec46[0])) + (2.23606801f * fRec48[0])) + (2.38047624f * fRec50[0])) + (2.51661158f * fRec52[0])) + (2.64575124f * fRec54[0])))) + ((4.5825758f * fRec56[0]) + ((4.35889912f * fRec58[0]) + ((4.12310553f * fRec60[0]) + ((3.87298346f * fRec62[0]) + ((3.60555124f * fRec64[0]) + ((3.31662488f * fRec66[0]) + ((3.0f * fRec68[0]) + ((2.23606801f * fRec70[0]) + (2.64575124f * fRec72[0]))))))))))))));
            iRec1[1] = iRec1[0];
            iRec2[1] = iRec2[0];
            iVec0[1] = iVec0[0];
            iVec1[1] = iVec1[0];
