...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void instanceClear() {
		...
		for (int i58 = 0; (i58 < 256); i58 = (i58 + 1)) {
			fVec28[i58] = 0.0f;
		...
		for (int i64 = 0; (i64 < 512); i64 = (i64 + 1)) {
			fVec31[i64] = 0.0f;
		...
		for (int i68 = 0; (i68 < 256); i68 = (i68 + 1)) {
			fVec33[i68] = 0.0f;
		...
		for (int i72 = 0; (i72 < 512); i72 = (i72 + 1)) {
			fVec35[i72] = 0.0f;
		...
		for (int i76 = 0; (i76 < 512); i76 = (i76 + 1)) {
			fVec37[i76] = 0.0f;
		...
		for (int i80 = 0; (i80 < 256); i80 = (i80 + 1)) {
			fVec39[i80] = 0.0f;
		...
		for (int i84 = 0; (i84 < 256); i84 = (i84 + 1)) {
			fVec41[i84] = 0.0f;
		...
		for (int i88 = 0; (i88 < 256); i88 = (i88 + 1)) {
			fVec43[i88] = 0.0f;
		...
		for (int i96 = 0; (i96 < 256); i96 = (i96 + 1)) {
			fVec47[i96] = 0.0f;
		...
		for (int i100 = 0; (i100 < 128); i100 = (i100 + 1)) {
			fVec49[i100] = 0.0f;
		...
		for (int i108 = 0; (i108 < 128); i108 = (i108 + 1)) {
			fVec53[i108] = 0.0f;
		...
		for (int i112 = 0; (i112 < 64); i112 = (i112 + 1)) {
			fVec55[i112] = 0.0f;
		...
		for (int i116 = 0; (i116 < 64); i116 = (i116 + 1)) {
			fVec57[i116] = 0.0f;
		...
		for (int i120 = 0; (i120 < 64); i120 = (i120 + 1)) {
			fVec59[i120] = 0.0f;
		...
		for (int i124 = 0; (i124 < 128); i124 = (i124 + 1)) {
			fVec61[i124] = 0.0f;
		...
		for (int i128 = 0; (i128 < 128); i128 = (i128 + 1)) {
			fVec63[i128] = 0.0f;
		...
		for (int i136 = 0; (i136 < 128); i136 = (i136 + 1)) {
			fVec67[i136] = 0.0f;
		...
		for (int i140 = 0; (i140 < 256); i140 = (i140 + 1)) {
			fVec69[i140] = 0.0f;
		...
		for (int i144 = 0; (i144 < 128); i144 = (i144 + 1)) {
			fVec71[i144] = 0.0f;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->openVerticalBox("Loops");
		ui_interface->openHorizontalBox("loop");
		ui_interface->addHorizontalSlider("level", &fVslider0, 0.0f, 0.0f, 6.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("loop48");
		ui_interface->declare(&fVslider3, "1", "");
		ui_interface->addHorizontalSlider("note", &fVslider3, 0.0f, 0.0f, 11.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("loop60");
		ui_interface->declare(&fVslider2, "1", "");
		ui_interface->addHorizontalSlider("note", &fVslider2, 0.0f, 0.0f, 11.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("loop72");
		ui_interface->declare(&fVslider1, "1", "");
		ui_interface->addHorizontalSlider("note", &fVslider1, 0.0f, 0.0f, 11.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(&fHslider0, "1", "");
		ui_interface->addVerticalSlider("master", &fHslider0, -20.0f, -60.0f, 0.0f, 0.00999999978f);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->addVerticalSlider("timbre", &fHslider1, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp3 = (1.0f + ftbl2[iRec4[0]]);
			...
			int iTemp16 = (fabsf((ftbl3[iRec4[0]] - 2.0f)) < 0.5f);
			iVec27[0] = iTemp16;
			fRec29[0] = ((fRec29[1] + float((float((iTemp16 - iVec27[1])) > 0.0f))) - (0.00665906491f * float((fRec29[1] > 0.0f))));
			fVec28[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec29[0] > 0.0f)))) + (0.497068316f * ((fTemp3 * fRec28[1]) + (fTemp4 * fRec28[2]))));
			fRec28[0] = fVec28[((IOTA - 149) & 255)];
			iVec29[0] = iSlow9;
			iRec33[0] = (iVec0[1]?0:(abs((iSlow9 - iVec29[1])) + iRec33[1]));
			ftbl4[((iTemp0 & ((iRec33[0] > 0) | iSlow10))?iRec4[0]:15)] = float(iSlow9);
			int iTemp17 = (fabsf((ftbl4[iRec4[0]] - 2.0f)) < 0.5f);
			iVec30[0] = iTemp17;
			fRec32[0] = ((fRec32[1] + float((float((iTemp17 - iVec30[1])) > 0.0f))) - (0.00332953245f * float((fRec32[1] > 0.0f))));
			fVec31[(IOTA & 511)] = ((4.65661287e-10f * (fTemp1 * float((fRec32[0] > 0.0f)))) + (0.494153798f * ((fTemp3 * fRec31[1]) + (fTemp4 * fRec31[2]))));
			fRec31[0] = fVec31[((IOTA - 299) & 511)];
			int iTemp18 = (fabsf((ftbl3[iRec4[0]] - 1.0f)) < 0.5f);
			iVec32[0] = iTemp18;
			fRec35[0] = ((fRec35[1] + float((float((iTemp18 - iVec32[1])) > 0.0f))) - (0.00593255227f * float((fRec35[1] > 0.0f))));
			fVec33[(IOTA & 255)] = ((0.496710479f * ((fRec34[1] * fTemp3) + (fRec34[2] * fTemp4))) + (4.65661287e-10f * (fTemp1 * float((fRec35[0] > 0.0f)))));
			fRec34[0] = fVec33[((IOTA - 167) & 255)];
			int iTemp19 = (fabsf((ftbl4[iRec4[0]] - 1.0f)) < 0.5f);
			iVec34[0] = iTemp19;
			fRec37[0] = ((fRec37[1] + float((float((iTemp19 - iVec34[1])) > 0.0f))) - (0.00296627614f * float((fRec37[1] > 0.0f))));
			fVec35[(IOTA & 511)] = ((4.65661287e-10f * (fTemp1 * float((fRec37[0] > 0.0f)))) + (0.493442565f * ((fTemp4 * fRec36[2]) + (fTemp3 * fRec36[1]))));
			fRec36[0] = fVec35[((IOTA - 336) & 511)];
			int iTemp20 = (fabsf((ftbl4[iRec4[0]] - 3.0f)) < 0.5f);
			iVec36[0] = iTemp20;
			fRec39[0] = ((fRec39[1] + float((float((iTemp20 - iVec36[1])) > 0.0f))) - (0.00373727386f * float((fRec39[1] > 0.0f))));
			fVec37[(IOTA & 511)] = ((4.65661287e-10f * (fTemp1 * float((fRec39[0] > 0.0f)))) + (0.494788289f * ((fTemp3 * fRec38[1]) + (fTemp4 * fRec38[2]))));
			fRec38[0] = fVec37[((IOTA - 266) & 511)];
			int iTemp21 = (fabsf((ftbl4[iRec4[0]] - 4.0f)) < 0.5f);
			iVec38[0] = iTemp21;
			fRec41[0] = ((fRec41[1] + float((float((iTemp21 - iVec38[1])) > 0.0f))) - (0.00444439286f * float((fRec41[1] > 0.0f))));
			fVec39[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec41[0] > 0.0f)))) + (0.495613843f * ((fTemp3 * fRec40[1]) + (fTemp4 * fRec40[2]))));
			fRec40[0] = fVec39[((IOTA - 224) & 255)];
			int iTemp22 = (fabsf((ftbl4[iRec4[0]] - 5.0f)) < 0.5f);
			iVec40[0] = iTemp22;
			fRec43[0] = ((fRec43[1] + float((float((iTemp22 - iVec40[1])) > 0.0f))) - (0.00498866197f * float((fRec43[1] > 0.0f))));
			fVec41[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec43[0] > 0.0f)))) + (0.496090502f * ((fTemp3 * fRec42[1]) + (fTemp4 * fRec42[2]))));
			fRec42[0] = fVec41[((IOTA - 199) & 255)];
			int iTemp23 = (fabsf((ftbl4[iRec4[0]] - 6.0f)) < 0.5f);
			iVec42[0] = iTemp23;
			fRec45[0] = ((fRec45[1] + float((float((iTemp23 - iVec42[1])) > 0.0f))) - (0.00593255227f * float((fRec45[1] > 0.0f))));
			fVec43[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec45[0] > 0.0f)))) + (0.496710479f * ((fTemp3 * fRec44[1]) + (fTemp4 * fRec44[2]))));
			fRec44[0] = fVec43[((IOTA - 167) & 255)];
			int iTemp24 = (fabsf((ftbl4[iRec4[0]] - 7.0f)) < 0.5f);
			iVec44[0] = iTemp24;
			fRec47[0] = ((fRec47[1] + float((float((iTemp24 - iVec44[1])) > 0.0f))) - (0.00665906491f * float((fRec47[1] > 0.0f))));
			fVec45[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec47[0] > 0.0f)))) + (0.497068316f * ((fTemp3 * fRec46[1]) + (fTemp4 * fRec46[2]))));
			fRec46[0] = fVec45[((IOTA - 149) & 255)];
			int iTemp25 = (fabsf((ftbl4[iRec4[0]] - 8.0f)) < 0.5f);
			iVec46[0] = iTemp25;
			fRec49[0] = ((fRec49[1] + float((float((iTemp25 - iVec46[1])) > 0.0f))) - (0.00747454772f * float((fRec49[1] > 0.0f))));
			fVec47[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec49[0] > 0.0f)))) + (0.49738732f * ((fTemp3 * fRec48[1]) + (fTemp4 * fRec48[2]))));
			fRec48[0] = fVec47[((IOTA - 132) & 255)];
			int iTemp26 = (fabsf((ftbl4[iRec4[0]] - 9.0f)) < 0.5f);
			iVec48[0] = iTemp26;
			fRec51[0] = ((fRec51[1] + float((float((iTemp26 - iVec48[1])) > 0.0f))) - (0.00888878573f * float((fRec51[1] > 0.0f))));
			fVec49[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec51[0] > 0.0f)))) + (0.497802079f * ((fTemp3 * fRec50[1]) + (fTemp4 * fRec50[2]))));
			fRec50[0] = fVec49[((IOTA - 111) & 127)];
			int iTemp27 = (fabsf((ftbl4[iRec4[0]] - 10.0f)) < 0.5f);
			iVec50[0] = iTemp27;
			fRec53[0] = ((fRec53[1] + float((float((iTemp27 - iVec50[1])) > 0.0f))) - (0.00997732393f * float((fRec53[1] > 0.0f))));
			fVec51[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec53[0] > 0.0f)))) + (0.498041421f * ((fTemp3 * fRec52[1]) + (fTemp4 * fRec52[2]))));
			fRec52[0] = fVec51[((IOTA - 99) & 127)];
			int iTemp28 = (fabsf((ftbl4[iRec4[0]] - 11.0f)) < 0.5f);
			iVec52[0] = iTemp28;
			fRec55[0] = ((fRec55[1] + float((float((iTemp28 - iVec52[1])) > 0.0f))) - (0.0118651045f * float((fRec55[1] > 0.0f))));
			fVec53[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec55[0] > 0.0f)))) + (0.498352528f * ((fTemp3 * fRec54[1]) + (fTemp4 * fRec54[2]))));
			fRec54[0] = fVec53[((IOTA - 83) & 127)];
			int iTemp29 = (fabsf((ftbl3[iRec4[0]] - 11.0f)) < 0.5f);
			iVec54[0] = iTemp29;
			fRec57[0] = ((fRec57[1] + float((float((iTemp29 - iVec54[1])) > 0.0f))) - (0.0237302091f * float((fRec57[1] > 0.0f))));
			fVec55[(IOTA & 63)] = ((4.65661287e-10f * (fTemp1 * float((fRec57[0] > 0.0f)))) + (0.499175578f * ((fTemp3 * fRec56[1]) + (fTemp4 * fRec56[2]))));
			fRec56[0] = fVec55[((IOTA - 41) & 63)];
			int iTemp30 = (fabsf((ftbl3[iRec4[0]] - 10.0f)) < 0.5f);
			iVec56[0] = iTemp30;
			fRec59[0] = ((fRec59[1] + float((float((iTemp30 - iVec56[1])) > 0.0f))) - (0.0199546479f * float((fRec59[1] > 0.0f))));
			fVec57[(IOTA & 63)] = ((4.65661287e-10f * (fTemp1 * float((fRec59[0] > 0.0f)))) + (0.499019742f * ((fTemp3 * fRec58[1]) + (fTemp4 * fRec58[2]))));
			fRec58[0] = fVec57[((IOTA - 49) & 63)];
			int iTemp31 = (fabsf((ftbl3[iRec4[0]] - 9.0f)) < 0.5f);
			iVec58[0] = iTemp31;
			fRec61[0] = ((fRec61[1] + float((float((iTemp31 - iVec58[1])) > 0.0f))) - (0.0177775715f * float((fRec61[1] > 0.0f))));
			fVec59[(IOTA & 63)] = ((4.65661287e-10f * (fTemp1 * float((fRec61[0] > 0.0f)))) + (0.498899847f * ((fTemp3 * fRec60[1]) + (fTemp4 * fRec60[2]))));
			fRec60[0] = fVec59[((IOTA - 55) & 63)];
			int iTemp32 = (fabsf((ftbl3[iRec4[0]] - 8.0f)) < 0.5f);
			iVec60[0] = iTemp32;
			fRec63[0] = ((fRec63[1] + float((float((iTemp32 - iVec60[1])) > 0.0f))) - (0.0149490954f * float((fRec63[1] > 0.0f))));
			fVec61[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec63[0] > 0.0f)))) + (0.498691946f * ((fTemp3 * fRec62[1]) + (fTemp4 * fRec62[2]))));
			fRec62[0] = fVec61[((IOTA - 65) & 127)];
			int iTemp33 = (fabsf((ftbl3[iRec4[0]] - 7.0f)) < 0.5f);
			iVec62[0] = iTemp33;
			fRec65[0] = ((fRec65[1] + float((float((iTemp33 - iVec62[1])) > 0.0f))) - (0.0133181298f * float((fRec65[1] > 0.0f))));
			fVec63[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec65[0] > 0.0f)))) + (0.498531997f * ((fTemp3 * fRec64[1]) + (fTemp4 * fRec64[2]))));
			fRec64[0] = fVec63[((IOTA - 74) & 127)];
			int iTemp34 = (fabsf((ftbl3[iRec4[0]] - 6.0f)) < 0.5f);
			iVec64[0] = iTemp34;
			fRec67[0] = ((fRec67[1] + float((float((iTemp34 - iVec64[1])) > 0.0f))) - (0.0118651045f * float((fRec67[1] > 0.0f))));
			fVec65[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec67[0] > 0.0f)))) + (0.498352528f * ((fTemp3 * fRec66[1]) + (fTemp4 * fRec66[2]))));
			fRec66[0] = fVec65[((IOTA - 83) & 127)];
			int iTemp35 = (fabsf((ftbl3[iRec4[0]] - 5.0f)) < 0.5f);
			iVec66[0] = iTemp35;
			fRec69[0] = ((fRec69[1] + float((float((iTemp35 - iVec66[1])) > 0.0f))) - (0.00997732393f * float((fRec69[1] > 0.0f))));
			fVec67[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec69[0] > 0.0f)))) + (0.498041421f * ((fTemp3 * fRec68[1]) + (fTemp4 * fRec68[2]))));
			fRec68[0] = fVec67[((IOTA - 99) & 127)];
			int iTemp36 = (fabsf((ftbl3[iRec4[0]] - 3.0f)) < 0.5f);
			iVec68[0] = iTemp36;
			fRec71[0] = ((fRec71[1] + float((float((iTemp36 - iVec68[1])) > 0.0f))) - (0.00747454772f * float((fRec71[1] > 0.0f))));
			fVec69[(IOTA & 255)] = ((4.65661287e-10f * (fTemp1 * float((fRec71[0] > 0.0f)))) + (0.49738732f * ((fTemp4 * fRec70[2]) + (fTemp3 * fRec70[1]))));
			fRec70[0] = fVec69[((IOTA - 132) & 255)];
			int iTemp37 = (fabsf((ftbl3[iRec4[0]] - 4.0f)) < 0.5f);
			iVec70[0] = iTemp37;
			fRec73[0] = ((fRec73[1] + float((float((iTemp37 - iVec70[1])) > 0.0f))) - (0.00888878573f * float((fRec73[1] > 0.0f))));
			fVec71[(IOTA & 127)] = ((4.65661287e-10f * (fTemp1 * float((fRec73[0] > 0.0f)))) + (0.497802079f * ((fTemp3 * fRec72[1]) + (fTemp4 * fRec72[2]))));
			fRec72[0] = fVec71[((IOTA - 111) & 127)];
			output0[i] = FAUSTFLOAT((fSlow0 * ((1.5f * (((((((((((0.977008402f * fRec0[0]) + (0.929320395f * fRec8[0])) + (0.879049063f * fRec10[0])) + (0.825722814f * fRec12[0])) + (0.768706143f * fRec14[0])) + fTemp10) + (0.639602125f * fRec18[0])) + (0.564076066f * fRec20[0])) + (0.4767313f * fRec22[0])) + (0.369274467f * fRec24[0])) + (0.213200718f * fRec26[0]))) + (0.977008402f * ((0.951189756f * (fRec28[0] + ((((((((((fRec31[0] + ((1.05131495f * fRec34[0]) + (1.05131495f * fRec36[0]))) + (0.945905328f * fRec38[0])) + (0.88852334f * fRec40[0])) + (0.827170193f * fRec42[0])) + (0.760885894f * fRec44[0])) + (0.688247204f * fRec46[0])) + (0.606976986f * fRec48[0])) + (0.512989163f * fRec50[0])) + (0.397359699f * fRec52[0])) + (0.22941573f * fRec54[0])))) + ((0.218217894f * fRec56[0]) + ((0.377964467f * fRec58[0]) + ((0.487950027f * fRec60[0]) + ((0.577350259f * fRec62[0]) + ((0.654653668f * fRec64[0]) + ((0.723746836f * fRec66[0]) + ((0.786795795f * fRec68[0]) + ((0.899735391f * fRec70[0]) + (0.845154226f * fRec72[0]))))))))))))));
			output1[i] = FAUSTFLOAT((fSlow0 * ((1.5f * ((((((fTemp10 + (((0.564076066f * fRec12[0]) + ((0.4767313f * fRec10[0]) + ((0.213200718f * fRec0[0]) + (0.369274467f * fRec8[0])))) + (0.639602125f * fRec14[0]))) + (0.768706143f * fRec18[0])) + (0.825722814f * fRec20[0])) + (0.879049063f * fRec22[0])) + (0.929320395f * fRec24[0])) + (0.977008402f * fRec26[0]))) + (0.213200718f * ((1.73205078f * (fRec28[0] + ((((((((((fRec31[0] + ((0.577350259f * fRec34[0]) + (0.577350259f * fRec36[0]))) + (1.29099441f * fRec38[0])) + (1.52752519f * fRec40[0])) + (1.73205078f * fRec42[0])) + (1.91485417f * fRec44[0])) + (2.08166599f * fRec46[0])) + (2.23606801f * fRec48[0])) + (2.38047624f * fRec50[0])) + (2.51661158f * fRec52[0])) + (2.64575124f * fRec54[0])))) + ((4.5825758f * fRec56[0]) + ((4.35889912f * fRec58[0]) + ((4.12310553f * fRec60[0]) + ((3.87298346f * fRec62[0]) + ((3.60555124f * fRec64[0]) + ((3.31662488f * fRec66[0]) + ((3.0f * fRec68[0]) + ((2.23606801f * fRec70[0]) + (2.64575124f * fRec72[0]))))))))))))));
			iRec1[1] = iRec1[0];
			iRec2[1] = iRec2[0];
			iVec0[1] = iVec0[0];
			iVec1[1] = iVec1[0];
